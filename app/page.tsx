        ...
        <section className="mb-4 sm:mb-5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-3.5 pr-12 py-2.5 sm:py-3 text-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:border-zinc-300 dark:focus:border-zinc-600 shadow-sm transition-colors duration-150"
            />
            <button
              onClick={addTask}
              className="absolute right-1.5 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-sm font-medium rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-700 active:scale-[0.97] transition-all duration-150"
            >
              +
            </button>
          </div>
